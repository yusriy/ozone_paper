...
# mainland
CA0003_abbas <- selectByDate(CA0003_model,start='1/1/2003',end='31/12/2013')
...
# mainland
CA0009_abbas <- selectByDate(CA0009_model,start='1/1/2003',end='31/12/2013')
...
# island
CA0038_abbas <- selectByDate(CA0038_model,start='1/1/2003',end='31/12/2013')
...
rm(CA0003_abbas,CA0009_abbas,CA0038_abbas)
