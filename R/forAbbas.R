...
write.table(CA0003_abbas,file='CA0003_abbas.csv',sep=',')
write.table(CA0009_abbas,file='CA0009_abbas.csv',sep=',')
write.table(CA0038_abbas,file='CA0038_abbas.csv',sep=',')